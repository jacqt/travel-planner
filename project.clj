(defproject travel-site "0.1.0-SNAPSHOT"
  ...
  :profiles {:dev {:source-paths ["env/dev/clj"]
                   ...
                   :repl-options {:init-ns travel-site.server
                   ...
                   :figwheel {:http-server-root "public"
                              ...
                              :ring-handler travel-site.server/http-handler}
